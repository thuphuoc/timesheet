...
*** TestCases ***
Create deduction            [Tags]    deduction
...
Create duplicate deduction  [Tags]    deduction
...
Delete deduction            [Tags]    deduction
    ${id_deduction}         Get value in list KV    ${enp_deduction}    $.result.data..id
