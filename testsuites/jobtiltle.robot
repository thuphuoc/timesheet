...
*** TestCases ***
Create jobtitle             [Tags]        Create jobtitle
...
Delete jobtitle             [Tags]        Delete jobtitle
    ${id_job}              Get value in list KV                ${enp_job}         $.result.data..id
