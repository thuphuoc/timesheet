...
Resource        ../../core/1nhanvien/payrate.robot
Suite setup     Fill enviroment and get token    ${env}
Suite Teardown      Delete Allowance And Deduction Of Employee
*** TestCases ***
Create payRateTemplate      [Tags]               allretailer      allfnb          allbooking      payrate
...
Update payRateTemplate      [Tags]               allretailer      allfnb          allbooking      payrate
...
Delete payrateTemplate      [Tags]               allretailer      allfnb          allbooking      payrate
